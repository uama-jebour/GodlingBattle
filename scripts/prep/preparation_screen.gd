...
func _apply_control_visual_emphasis() -> void:
	...
	var preset_button_normal := _build_block_style(Color(0.78, 0.36, 0.12, 0.98), Color(1.0, 0.8, 0.56, 1.0), 3)
	var preset_button_hover := _build_block_style(Color(0.9, 0.45, 0.16, 1.0), Color(1.0, 0.89, 0.69, 1.0), 3)
	var preset_button_press := _build_block_style(Color(0.66, 0.29, 0.09, 1.0), Color(1.0, 0.74, 0.47, 1.0), 3)
	var preset_button_focus := _build_block_style(Color(0.84, 0.42, 0.15, 1.0), Color(1.0, 0.95, 0.87, 1.0), 4)
	apply_preset_button.add_theme_font_size_override("font_size", 34)
	apply_preset_button.add_theme_color_override("font_color", Color(1.0, 0.98, 0.94))
	apply_preset_button.add_theme_stylebox_override("normal", preset_button_normal)
	apply_preset_button.add_theme_stylebox_override("hover", preset_button_hover)
	apply_preset_button.add_theme_stylebox_override("pressed", preset_button_press)
	apply_preset_button.add_theme_stylebox_override("focus", preset_button_focus)
	start_battle_button.add_theme_font_size_override("font_size", 40)
	start_battle_button.add_theme_color_override("font_color", Color(0.98, 1.0, 0.98))
